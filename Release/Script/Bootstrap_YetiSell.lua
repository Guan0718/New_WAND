...
maple.HuntMapList =     -- append hunt map ID, and SafeSpot here
    {
        {ID=211040200,SafeSpot={163, -2078}},
...
maple.PlayerWhiteList = {"Kevincurry","EsoChen",}        -- player white list, you can put your partner's ign  here
...
maple.Movement=
    {   MaxJump = 80,
        ...
        TeleportWhenPathFail = false,    -- use teleport hack when path to one point cannot be found
...
store.SellWhenEquipsMoreThan= 5         
...
store.Potion =
   {
      ...
      FeedDelay=5.2,             -- Auto pot delay in sec
      AutoHpThreshold=900,      
...
hunt.Attack =
    {
        ...
        MobFind = 0,          -- find mobs in a group of x
        Range = {
            IsFan = false,
            FanMinDistance = 60,
            Front = 30,      -- attack range in front: for spear, probably 120
            Back = 30,        -- attack range: back
            Top = 60,        -- attack range: top
            Bottom = 2,
        },
        count=0
    }
